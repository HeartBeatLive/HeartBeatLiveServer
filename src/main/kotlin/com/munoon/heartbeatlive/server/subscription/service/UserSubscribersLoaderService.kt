...
class UserSubscribersLoaderService(
    ...
    private val cache = cache2kBuilder<String, Map<String, String>>()
        ...
        .loader { userId ->
            runBlocking { service.getAllActiveUserSubscribers(userId).toList(arrayListOf()) }
    ...
    // load user's active subscribers and return as map of [subscription id -> subscriber user id]
