...
import com.munoon.heartbeatlive.server.config.properties.FirebaseFunctionProperties
...
@Component
class FirebaseFunctionAuthentication(private val properties: FirebaseFunctionProperties) {
