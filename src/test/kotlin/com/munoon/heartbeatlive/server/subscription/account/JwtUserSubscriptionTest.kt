...
internal class JwtUserSubscriptionTest {
    ...
    fun createFromJwtClaimMap() {
        ...
        val expirationTimeInstance = Instant.ofEpochSecond(expirationTimeEpochSeconds)
        val expectedJwtUserSubscription = JwtUserSubscription(UserSubscriptionPlan.PRO, expirationTimeInstance)
